...
module.exports = {
	...
	avgOfYvalue2 = avgOfYvalue2/arrayOfYvalue2.length;
        ...
        responseHTML = responseHTML.replace("id=\"@sDate\"", "id=\"@sDate\"" + "value=\"" + moment(sdate).format("YYYY-MM-DD") + "\"");
        responseHTML = responseHTML.replace("id=\"@eDate\"", "id=\"@eDate\"" + "value=\"" + moment(edate).format("YYYY-MM-DD") + "\"");
